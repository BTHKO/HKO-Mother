...
<body>
  <div class="app">
    <div class="row">
      ...
      <div class="status-pill" id="status-pill">Checking status…</div>
    </div>
  ...
  <script>
    ...
    async function refreshStatus() {
      ...
      setPill(`${data.system} • ${data.status} • Desktop: ${data.desktop_ready ? 'OK' : 'Missing'}`, data.desktop_ready ? 'good' : 'warn');
    }
...
if __name__ == "__main__":
    print(f"🛡️ {APP_NAME} {VERSION} INITIALIZED (DESKTOP MODE)")
